...
export function TeamDetailNav({
	...
	return (
		<nav
			className="team-detail-nav bg-base-200 border-secondary sticky top-0 z-40 -mx-4 border-b-2 px-4 pt-1 pb-0 shadow-[0_4px_12px_-2px_rgba(0,0,0,0.08)] lg:top-[var(--navbar-height-desktop)]"
